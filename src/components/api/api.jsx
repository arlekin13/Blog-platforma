...
export const getArticle = async (slug) => {
  ...
  try {
    const response = await axios.get(`${API_BASE_URL}/articles/${slug}`, { headers });
    return response.data;
  } catch (error) {
...
export const unlikeArticle = async (slug) => {
  ...
  try {
    const response = await axios.delete(`${API_BASE_URL}/articles/${slug}/favorite`, {
      headers: authHeader(),
    });
    return response.data;
  } catch (error) {
...
export const profileEdit = async (userData) => {
  const tokenValue = getToken();
  if (!tokenValue) {
